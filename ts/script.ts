const css = document.querySelector("h3") as HTMLHeadingElement;
...
const body = document.getElementById("gradient") as HTMLBodyElement;
const textl: NodeListOf<HTMLHeadingElement> = document.querySelectorAll("h1, h2, h3");
const ranButton = document.querySelector(".random") as HTMLButtonElement;
...
function check2(i: HTMLInputElement) {
